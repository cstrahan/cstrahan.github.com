...
If you're interested in delving into such Functional Programming topics, this blog post is for you. I would like to note, however, that ML programmers can skip this entire post and read "That About Wraps it Up":http://www.lfcs.inf.ed.ac.uk/reports/97/ECS-LFCS-97-375/ by Bruce J. McAdam, which serves as the inspiration for much of this post; if you're a C# person, such as myself, you're in the right place.
