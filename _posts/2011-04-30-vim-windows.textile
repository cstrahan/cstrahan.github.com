...
Add gVim as an external tool. Go to <code>Tools > External Tools > Add</code> and plug in the following:
...
By specifying <code>--servername VimualStudio</code>, you'll have a dedicated vim process just for Visual Studio.
